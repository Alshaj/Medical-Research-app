...
export const RecordList: React.FC = () => {
  ...
  // Filter records based on user search query & outcome dropdown
  ...
  return (
    <div className="bg-white rounded-2xl p-5 border border-slate-200 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between space-y-4">
      <div>
        ...
        <h3 className="text-base font-bold text-slate-800 mt-3 line-clamp-1">{record.diagnosis}</h3>
        ...
        <div className="mt-4 pt-3 border-t border-slate-100 grid grid-cols-2 gap-2 text-xs text-slate-600">
          ...
          <div>
            <span className="text-slate-400">Active Symptoms:</span>{' '}
            <span className="font-medium text-slate-700">{activeSymptomsCount} Present</span>
          </div>
        </div>
      </div>
